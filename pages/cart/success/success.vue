<template>
	<view>
		...
		<view class="footer">
			<view class="btn" style="border-right: 1px solid #EEEEEE;" @click="navgo('list')">订单列表</view>
			<view class="btn" @click="navgo('data')">订单详情</view>
		</view>
		<!-- 提示-备注 -->
		<view class="order">
			<view class="row">
		...
		methods: {
			...
			navgo(type) {
				if (type == 'list') {
					...
					uni.redirectTo({
						url: '/pages/oreder-detail/index?sn=' + mvc.sn
					})
				}
			}
		},
